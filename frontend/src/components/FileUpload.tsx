  ...
  return (
    <div className='session-files-container'>
      ...
      <div className='right'>
        ...
        <p>
          <small>
            Click on one of the sample clients below to load pre-populated data
            for analysis.
          </small>{' '}
        </p>
        <div className='sample-holder'>
          <button onClick={() => handleSampleLoad('client1')}>Client 1</button>
          <button onClick={() => handleSampleLoad('client2')}>Client 2</button>
          <button onClick={() => handleSampleLoad('client3')}>Client 3</button>
        </div>
      </div>
    </div>
  );
